...
export default async function Login(props: { searchParams: Promise<Message> }) {
  ...
  return (
    <form className="flex flex-col w-full h-[calc(100vh-4rem)] justify-center items-center">
      <div className="w-full max-w-[600px] aspect-[6/5] flex flex-col items-center justify-center bg-white rounded-3xl p-0 border-[3px] border-[#c8c8c8]">
        ...
        <div className="flex flex-col gap-2 [&>input]:mb-3 mt-12 w-2/3">
